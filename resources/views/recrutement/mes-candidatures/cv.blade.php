                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        @else
                            ...
                            <div class="mb-4">
                                ...
                                @if ($cvPrincipal)
                                    <div
                                        class="alert alert-info rounded-4 d-flex justify-content-between align-items-center">
                                        <div>
                                            <i class="bi bi-file-pdf me-2"></i>
                                            <strong>{{ $cvPrincipal->titre }}</strong>
                                            <span class="text-muted ms-2">(principal)</span>
                                        </div>
                                        <a href="{{ asset('storage/' . $cvPrincipal->cv_path) }}" target="_blank"
                                        ...
                                        @foreach ($anciensCvs as $cv)
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted ms-2">(déposé le
                                                        {{ $cv->created_at->format('d/m/Y H:i') }})</small>
                                                </div>
                            ...
                            <form action="{{ route('admin.mes-candidatures.cv.update') }}" method="POST"
                            ...
                            <form action="{{ route('admin.mes-candidatures.cv.visibility') }}" method="POST">
                                ...
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="cv_public" id="cvPublic" value="1"
                                        {{ $etudiant->cv_public ? 'checked' : '' }}>
