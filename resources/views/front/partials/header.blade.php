<header class="front-header">
    <div class="container">
            ...
            <nav class="nav-links" id="frontNavLinks">
                ...
                @auth
                    ...
                    @role('etudiant')
                        ...
                        @endphp
                        <a href="{{ route('front.alertes.index') }}" class="alerte-bell {{ $alerteActive ? 'is-active' : '' }}"
                ...
                <button id="pwa-install-btn" onclick="installPWA()" class="d-none"
                    style="
        display:inline-flex;
        align-items:center;
        gap:6px;
        padding:8px 16px;
        border-radius:999px;
        border:1px solid rgba(30,74,118,.2);
        background:#fff;
        color:#1e4a76;
        font-size:13px;
        font-weight:600;
